...
st.markdown("""
- 🧠 **DDPG** – Great returns, less stable  
- 🔒 **TD3** – More robust but compute-heavy  
- 🔁 **SAC** – Stable but less performant in volatility  
- ⛓️ **A2C** – Constrained by on-policy design  
""")
...
# --- DOWNLOADS ---
st.header("📥 Downloads")
st.download_button("📉 Download Final Dataset (XLSX)", open("final_dataset.xlsx", "rb"), file_name="final_dataset.xlsx")
